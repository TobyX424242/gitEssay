/**
 * gitEssay — ComponentPickerPlugin ("/" slash menu).
 *
 * Forked from lexical-playground/src/plugins/ComponentPickerPlugin. Stripped
 * the demo options (Excalidraw, Poll, embeds, Date/Today/Tomorrow/Yesterday,
 * GIF, Card, Pull Quote, Review, Columns Layout). Keeps the academic-useful
