 ...
 * key is server-side. This is the thin frontend client: `testConnection` posts
 * the form values to /api/ai/test, and `streamChat` POSTs a multi-turn
 * {system, messages} to /api/chat/stream and consumes the SSE event stream
 * (thinking/text/done/error) for the agent loop.
 */
